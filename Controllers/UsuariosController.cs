...
namespace BibliotecaMVC.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(BiblioDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IDUsuario,Nombre,Apellido,DNI,FechaNacimiento,Contraseña")] Usuario usuario)
        {
